...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public static function isAdmin($userId = null) {
        return self::find()->where([
            'group_id' => 1, 
            'id' => ($userId == null ? self::getUserId() : $userId)
            ])->exists();
    }
    ...
    public static function deleteAllRelated($userId) {
        $user = self::findOne($userId);
        $commissionShipping = CommissionShippingCost::findOne(['user_id' => $userId]);
        return $user->delete() && $commissionShipping->delete();
    }
}
