...
class PriceListController extends Controller
{
    ...
    public function actionAll() {
        ...
        $query = PriceListHeader::find()->orderBy('id DESC');
    ...
    public function actionDelete() {
        ...
        $priceListHeader = PriceListHeader::findOne($priceListHeaderId);
        $priceListItemDeletedNum = PriceListItem::deleteAll(['price_list_header_id' => $priceListHeaderId]);


        if( $priceListHeader->delete() &&  $priceListItemDeletedNum >= 1 ) {
            App::alert('success', 'Price list was deleted');
        } else {
            App::alert('danger', 'Error while deleting the price list.');
        }
